...
function Extreme5_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function Extreme5_button($variables) {
 ...
 */
function Extreme5_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function Extreme5_menu_local_task($variables) {
 ...
 */
function Extreme5_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function Extreme5_node_preview($variables) {
  $node = $variables['node'];
...
if (strpos ($key, "comment") !== FALSE) {
		...
		ob_start();?>
		<img class="art-metadata-icon" src="<?php echo get_full_path_to_theme(); ?>/images/postcommentsicon.png" width="11" height="9" alt="" /> <?php
		$output .= ob_get_clean();
		$output .= $link_output;
		$index++;
		continue;
