...
function Extreme5_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Extreme5_feed_icon($url, $title) {
 ...
 */
function Extreme5_preprocess_comment_wrapper(&$vars) {
 ...
 */
function Extreme5_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Extreme5_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Extreme5_button($element) {
...
*/
function Extreme5_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function Extreme5_node_preview($node) {
