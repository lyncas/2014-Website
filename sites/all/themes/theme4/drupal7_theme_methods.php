...
function theme4_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function theme4_button($variables) {
 ...
 */
function theme4_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function theme4_menu_local_task($variables) {
 ...
 */
function theme4_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function theme4_node_preview($variables) {
  $node = $variables['node'];
