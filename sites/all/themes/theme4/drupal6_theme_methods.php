...
function theme4_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function theme4_feed_icon($url, $title) {
 ...
 */
function theme4_preprocess_comment_wrapper(&$vars) {
 ...
 */
function theme4_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function theme4_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function theme4_button($element) {
...
*/
function theme4_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function theme4_node_preview($node) {
