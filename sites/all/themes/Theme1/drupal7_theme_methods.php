...
function Theme1_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function Theme1_button($variables) {
 ...
 */
function Theme1_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function Theme1_menu_local_task($variables) {
 ...
 */
function Theme1_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function Theme1_node_preview($variables) {
  $node = $variables['node'];
