...
function Theme1_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Theme1_feed_icon($url, $title) {
 ...
 */
function Theme1_preprocess_comment_wrapper(&$vars) {
 ...
 */
function Theme1_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Theme1_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Theme1_button($element) {
...
*/
function Theme1_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function Theme1_node_preview($node) {
