...
function theme5_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function theme5_button($variables) {
 ...
 */
function theme5_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function theme5_menu_local_task($variables) {
 ...
 */
function theme5_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function theme5_node_preview($variables) {
  $node = $variables['node'];
