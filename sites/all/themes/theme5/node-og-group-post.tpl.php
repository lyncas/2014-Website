...
<h2 class="art-postheader"<?php print $title_attributes; ?>><img src="<?php echo get_full_path_to_theme(); ?>/images/postheadericon.png" width="26" height="26" alt="" /><?php print render($title_prefix); ?>
