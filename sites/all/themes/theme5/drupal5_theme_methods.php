 ...
 * @ingroup themeable
 */
function theme5_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function theme5_comment_wrapper($content, $type = null) {
  static $node_type;
