...
function theme5_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function theme5_feed_icon($url, $title) {
 ...
 */
function theme5_preprocess_comment_wrapper(&$vars) {
 ...
 */
function theme5_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function theme5_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function theme5_button($element) {
...
*/
function theme5_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function theme5_node_preview($node) {
