 ...
 * @ingroup themeable
 */
function theme3_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function theme3_comment_wrapper($content, $type = null) {
  static $node_type;
