...
function theme3_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function theme3_button($variables) {
 ...
 */
function theme3_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function theme3_menu_local_task($variables) {
 ...
 */
function theme3_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function theme3_node_preview($variables) {
  $node = $variables['node'];
