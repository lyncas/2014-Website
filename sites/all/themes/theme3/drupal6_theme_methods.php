...
function theme3_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function theme3_feed_icon($url, $title) {
 ...
 */
function theme3_preprocess_comment_wrapper(&$vars) {
 ...
 */
function theme3_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function theme3_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function theme3_button($element) {
...
*/
function theme3_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function theme3_node_preview($node) {
