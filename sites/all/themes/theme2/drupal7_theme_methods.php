...
function theme2_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function theme2_button($variables) {
 ...
 */
function theme2_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function theme2_menu_local_task($variables) {
 ...
 */
function theme2_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function theme2_node_preview($variables) {
  $node = $variables['node'];
