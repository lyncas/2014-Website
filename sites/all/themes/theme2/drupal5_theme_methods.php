 ...
 * @ingroup themeable
 */
function theme2_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 */
function theme2_comment_wrapper($content, $type = null) {
  static $node_type;
