...
function theme2_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function theme2_feed_icon($url, $title) {
 ...
 */
function theme2_preprocess_comment_wrapper(&$vars) {
 ...
 */
function theme2_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function theme2_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function theme2_button($element) {
...
*/
function theme2_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function theme2_node_preview($node) {
