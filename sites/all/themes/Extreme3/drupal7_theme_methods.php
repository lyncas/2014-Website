...
function Extreme3_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function Extreme3_button($variables) {
 ...
 */
function Extreme3_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function Extreme3_menu_local_task($variables) {
 ...
 */
function Extreme3_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function Extreme3_node_preview($variables) {
  $node = $variables['node'];
