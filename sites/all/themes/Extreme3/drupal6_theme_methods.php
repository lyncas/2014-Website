...
function Extreme3_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Extreme3_feed_icon($url, $title) {
 ...
 */
function Extreme3_preprocess_comment_wrapper(&$vars) {
 ...
 */
function Extreme3_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Extreme3_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Extreme3_button($element) {
...
*/
function Extreme3_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function Extreme3_node_preview($node) {
