 ...
 * @ingroup themeable
 */
function Extreme3_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function Extreme3_feed_icon($url) {
 ...
 */
function Extreme3_comment_wrapper($content, $type = null) {
  static $node_type;
