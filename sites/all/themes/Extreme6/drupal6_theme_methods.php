...
function Extreme6_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Extreme6_feed_icon($url, $title) {
 ...
 */
function Extreme6_preprocess_comment_wrapper(&$vars) {
 ...
 */
function Extreme6_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Extreme6_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Extreme6_button($element) {
...
*/
function Extreme6_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function Extreme6_node_preview($node) {
