 ...
 * @ingroup themeable
 */
function Extreme6_menu_local_task($mid, $active, $primary) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   The url of the feed.
 */
function Extreme6_feed_icon($url) {
 ...
 */
function Extreme6_comment_wrapper($content, $type = null) {
  static $node_type;
