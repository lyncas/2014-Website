...
function Extreme6_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function Extreme6_button($variables) {
 ...
 */
function Extreme6_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function Extreme6_menu_local_task($variables) {
 ...
 */
function Extreme6_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function Extreme6_node_preview($variables) {
  $node = $variables['node'];
