...
function Extreme_menu_local_task($link, $active = FALSE) {
  $active_class = "";
  if ($active) {
    $active_class .= "active ";
  }
 ...
 *   A descriptive title of the feed.
  */
function Extreme_feed_icon($url, $title) {
 ...
 */
function Extreme_preprocess_comment_wrapper(&$vars) {
 ...
 */
function Extreme_breadcrumb($breadcrumb) {
  if (!empty($breadcrumb)) {
    return '<div class="breadcrumb art-postcontent">'. implode(' | ', $breadcrumb) .'</div>';
  }
}

function Extreme_service_links_node_format($links) {
 ...
 * @ingroup themeable
 */
function Extreme_button($element) {
...
*/
function Extreme_img_assist_page($content, $attributes = NULL) {
 ...
 * @ingroup themeable
 */
function Extreme_node_preview($node) {
