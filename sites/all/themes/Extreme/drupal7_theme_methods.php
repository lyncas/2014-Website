...
function Extreme_breadcrumb($variables) {
 ...
 * @ingroup themeable
 */
function Extreme_button($variables) {
 ...
 */
function Extreme_preprocess_page(&$vars) {
 ...
 * @ingroup themeable
 */
function Extreme_menu_local_task($variables) {
 ...
 */
function Extreme_feed_icon($variables) {
 ...
 * @ingroup themeable
 */
function Extreme_node_preview($variables) {
  $node = $variables['node'];
